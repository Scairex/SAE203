...
<body>
    ...
    <?php
        ...
        $requete = "SELECT reclat, reclong FROM meteorites LIMIT 100"; // Limite l'affichage à 100 points
        ...
        while ($row = mysqli_fetch_assoc($resultat)) {
            echo "<script>addPoint($row[reclat], $row[reclong], 10, Cesium.Color.PURPLE);</script>";
        }
    ?>
</body>
</html>