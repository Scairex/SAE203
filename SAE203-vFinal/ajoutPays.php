<html>
    ...
    <body>
        ...
        // Récupération de la liste des colonnes de la table countries
        $requete_colonnes = "SHOW COLUMNS FROM countries";
        ...
        if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["addData"])) {
            ...
            $requeteInsert = "INSERT INTO countries VALUES ('$valuesString')";
            mysqli_query($conn, $requeteInsert) or die(mysqli_error($conn));
        ...
        <h2>Ajouter de nouvelles valeurs :</h2>
        <form method="POST" action="">
            <?php
            foreach ($colonnes as $col) {
            ...
            ?>
            <button type="submit" name="addData">Ajouter</button>
        </form>
