...
<body>
    ...
    <?php
        ...
        $requete = "SELECT latitude, longitude FROM countries"; // Limite l'affichage à 10 points
        ...
        while ($row = mysqli_fetch_assoc($resultat)) {
            echo "<script>addPoint($row[latitude], $row[longitude], 10, Cesium.Color.PURPLE);</script>";
        }
    ?>
</body>
</html>
